...
<table>
  ...
  <tr>
    <td>
      <img width="100%" alt="Screenshot 2026-01-01 212348" src="https://github.com/user-attachments/assets/f97f34c0-a523-4c8c-9d64-35ebcbcff72f" />
    </td>
    <td>
      <img width="100%" alt="Screenshot 2026-01-01 213712" src="https://github.com/user-attachments/assets/c0eb4df3-ab05-435d-8244-2872fdcc51f9" />
    </td>
  </tr>
</table>
...
- AI Code Generation - Convert Figma designs into Azeorex templates (Still in development)

### 🚀 Agency Services
- End-to-end web design and full-stack development
- Best for detailed more complex projects
- Professional design and development services

## Getting Started
- Sign up for an account
- Choose to create a new project or browse templates
- Customize your site or template
- Deploy and go live
...
- In production, my DNS should support wild card subdomains, Add  a DNS record like `*.azeorex.com` -> pointing to your Next.js server IP.
- Use middleware to detect subdomain.
- For a request to https://subdomain.azeorex.com/, the server internally rewrites the request to https://azeorex.com/subdomain, while the user sees https://subdomain.azeorex.com/.
...
- [@sayandas](https://github.com/Sayan-01)
