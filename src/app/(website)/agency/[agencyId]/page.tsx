        ...
        <div className="flex gap-4 flex-col xl:!flex-row">
          ...
          <Card className="flex-1 relative">
            <CardHeader>
              ...
              <CardTitle className="text-4xl">{funnels.length}</CardTitle>
            </CardHeader>
            ...
            <CardFooter>
              <div className="flex flex-col w-full">
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground text-sm">Current: {funnels.length}</span>
                  <span className="text-muted-foreground text-sm">Goal: {agencyDetails.goal}</span>
                </div>
                <Progress value={(funnels.length / agencyDetails.goal) * 100} />
              </div>
            </CardFooter>
