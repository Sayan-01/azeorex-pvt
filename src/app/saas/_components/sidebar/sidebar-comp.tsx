...
const SidebarComp = ({ defaultOption }: Props) => {
  ...
  return (
    <Sheet
      ...
      {...openState}
    >
      <SheetTrigger className="h-9 w-9 flex flex-col items-center justify-center rounded-xl border border-[#545454]/30 absolute z-[50] md:hidden right-5 top-5 outline-none">
