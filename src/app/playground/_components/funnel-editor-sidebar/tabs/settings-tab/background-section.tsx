      ...
      <AccordionContent className="flex flex-col gap-3">
        ...
        <div className="w-full flex items-center">
          ...
          <Input
            ...
            placeholder="px"
            id="filter"
            onChange={(e) => updateStyle(selectedElement.id, "filter", e.target.value)}
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-1  rounded-md group">
            ...
            <Input
              ...
              id="backgroundImage"
              onChange={(e) => updateStyle(selectedElement.id, "backgroundImage", e.target.value)}
        ...
        <div className="flex items-center">
          ...
          <Tabs
            className="flex-1"
            onValueChange={(e) => updateStyle(selectedElement.id, "backgroundSize", e)}
