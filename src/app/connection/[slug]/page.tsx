    ...
    <div className="bg-bcgc">
      ...
      <Wrapper className="min-h-screen relative sm:pt-[90px] pt-[70px] sm:mb-[95px] mb-[75px] z-10">
        ...
        <div className="text-center w-full mb-12">
          <h1 className="mt-2 mb-6  font-semibold leading-[1.1] md:text-[55px] sm:text-[45px] text-[38px]">{slug}</h1>
        ...
        <div className="flex flex-col-reverse sm:flex-row">
          ...
          <div className="w-full items-start flex flex-col">
            ...
            <p className="text-white/60 md:max-w-[80%]">Completion Time 24/7 for Email and live chat Address howrah, Westbengal, India Email sayandas@gmsil.com</p>
