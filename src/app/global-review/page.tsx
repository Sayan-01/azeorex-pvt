...
const LovableLandingPage: React.FC = () => {
  return (
    <div className="h-screen bg-[#141414] text-white flex flex-col relative">
      {/* Navigation */}
      ...
      {/* Hero Section */}
      <main className="flex flex-col items-center justify-center px-4 py-16 text-center sm:mt-[95px] mt-[75px] relative z-10 flex-1">
        ...
        {/* Input Section */}
        <div className="w-full max-w-3xl mb-26">
