    ...
    <div className="h-screen bg-[#141414] text-white">
      ...
      <main className="flex flex-col items-center justify-center px-4 py-16 text-center sm:mt-[95px] mt-[75px]">
        ...
        <div className="w-full max-w-3xl mb-8">
          <Card className="bg-zinc-800 border-2 border-dashed border-blue-500 shadow-lg">
            <div className="p-3">
              <GlobalReviewForm />
            </div>
          </Card>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-16">
          {["AI image generator", "Remotion video", "Fitness tracker", "Task manager"].map((item) => (
            <Button
              key={item}
              variant="outline"
              className="bg-zinc-800 text-white rounded-full hover:bg-zinc-800"
            >
              {item}
              <ArrowUpIcon />
            </Button>
        ...
        <div className="mt-2 flex flex-col items-center">
          <div className="mb-4">
            <p className="text-xl font-medium">Join 140,000+ people using Azeorex</p>
          </div>
