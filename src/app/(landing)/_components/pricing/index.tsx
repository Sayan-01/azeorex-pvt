    ...
    return (
      ...
      >
        <Heading
          ...
          p="Pricing service is temporarily unavailable. Please try again later."
        />
      </section>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex xl:flex-row flex-col gap-2">
        <PriceCard
          features={["You can create only 1 project.", "1000 credits for AI tasks.", "Full access of SAAS website builder.", "Basic dashboard features.", "Basic SAAS editor."]}
        ...
        <PriceCard
          features={["You can create only 5 projects.", "10,000 credits for AI tasks.", "Full access of SAAS website builder.", "Advanced dashboard features.", "Advanced SAAS editor."]}
        ...
        <PriceCard
          features={["You can create unlimited projects.", "100,000 credits for AI tasks.", "Full access of SAAS website builder.", "Advanced dashboard features.", "Advanced SAAS editor."]}
          border="border-zinc-400/10 bg-[#0a0d24] xl:scale-90"
          title="Premium Plan"
          tag="$49 /"
          color="text-[#b4b0a3]"
