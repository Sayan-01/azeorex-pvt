                  ...
                  {session ? (
                    <>
                      <div className="hidden sm:flex">
                        <Link
                          target="_blank"
                          className="rounded-full flex items-center justify-center gap-2 bg-gray-100 px-5 py-3 text-sm font-medium text-teal-600 bg-gradient-to-br dark:from-blue-800 dark:via-blue-500 dark:to-blue-800 dark:text-white dark:hover:text-white/75"
                          href={`/saas/projects`}
                        >
