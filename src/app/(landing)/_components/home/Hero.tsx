...
const popp = Paytone_One({ subsets: ["latin"], weight: "400" });
        ...
        <Container_y>
          <div className="flex justify-center relative lg:mt-40 md:mt-44 mt-40 mb-16 my-44 z-10">
            <div className=" flex flex-col items-center justify-center max-w-[89vw] md:max-w-2xl lg:max-w-[64vw]">
              ...
              <h1 className={`${popp.className} text-center font-extrabold text-[35px] md:text-[48px] lg:text-[65px] leading-tight md:leading-[1.1]`}>
                Transform
