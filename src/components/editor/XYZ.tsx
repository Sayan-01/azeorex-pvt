...
const element = state.editor.selectedElement as EditorElement;
  ...
  const ResizeHandles = () => (
    <div className="pointer-events-auto">
      {/* Right resize handle */}
      <div
        className={`absolute z-[1009] right-0 top-0 bottom-0 w-2 cursor-ew-resize bg-transparent hover:bg-blue-500/20 ${element.styles?.width?.toString().includes("px") ? "" : "hidden"}`}
        onMouseDown={(e) => handleMouseDown(e, "right")}
      />

      {/* Bottom resize handle */}
      <div
        className={`absolute z-[1009] bottom-0 left-0 right-0 h-2 cursor-ns-resize bg-transparent hover:bg-blue-500/20 ${element.styles?.height?.toString().includes("px") ? "" : "hidden"}`}
        onMouseDown={(e) => handleMouseDown(e, "bottom")}
      />

      {/* Corner resize handle */}
      <div
        className={`absolute z-[1009] bottom-0 right-0 w-4 h-4 cursor-nwse-resize bg-transparent hover:bg-blue-500/20`}
    ...
    <div className=" pointer-events-auto">
      ...
      >
        <div
          ...
          className="w-3 hover:w-6 duration-200 h-2 bg-green-500 border-white border-2 rounded-full cursor-ns-resize hover:bg-green-600 -mb-[16px]"
        />
      </div>
      ...
      >
        <div
          ...
          className="h-3 w-2 hover:h-6 duration-200 bg-green-500 border-white border-2 rounded-full cursor-ew-resize hover:bg-green-600 -ml-[16px]"
        />
      </div>
      ...
      >
        <div
          ...
          className="w-3 hover:w-6 duration-200 h-2 bg-green-500 border-white border-2 rounded-full cursor-ns-resize hover:bg-green-600 -mt-[16px]"
        />
      </div>
      ...
      >
        <div
          ...
          className="h-3 w-2 hover:h-6 duration-200 bg-green-500 border-white border-2 rounded-full cursor-ew-resize hover:bg-green-600 -mr-[16px]"
        />
      </div>
    </div>
  );
  ...
  const MarginHandles = () => (
    <div className=" pointer-events-auto">
      ...
      <div
        ...
        className={`absolute z-[1010] left-0 right-0 flex items-end justify-center bg-orange-500/20 ${element.styles?.marginTop?.toString().includes("px") ? "" : "hidden"}`}
      >
        <div
          onMouseDown={(e) => handleMouseDown(e, "margin-top")}
          className="w-3 hover:w-6 duration-200 h-2 bg-orange-400 border-white border-2 rounded-full cursor-ns-resize hover:bg-orange-600 -mb-2"
        />
      </div>
      ...
      <div
        ...
        className={`absolute z-[1010] top-0 bottom-0 flex items-center justify-start bg-orange-500/20 ${element.styles?.marginRight?.toString().includes("px") ? "" : "hidden"}`}
      >
        <div
          onMouseDown={(e) => handleMouseDown(e, "margin-right")}
          className="h-3 hover:h-6 duration-200 w-2 bg-orange-400 border-white border-2 rounded-full cursor-ew-resize hover:bg-orange-600 -ml-2"
        />
      </div>
      ...
      <div
        ...
        className={`absolute z-[1010] left-0 right-0 flex items-start justify-center bg-orange-500/20 ${element.styles?.marginBottom?.toString().includes("px") ? "" : "hidden"}`}
      >
        <div
          onMouseDown={(e) => handleMouseDown(e, "margin-bottom")}
          className="w-3 hover:w-6 duration-200 h-2 bg-orange-400 border-white border-2 rounded-full cursor-ns-resize hover:bg-orange-600 -mt-2"
        />
      </div>
      ...
      <div
        ...
        className={`absolute z-[1010] top-0 bottom-0 flex items-center justify-end bg-orange-500/20 ${element.styles?.marginLeft?.toString().includes("px") ? "" : "hidden"}`}
      >
        <div
          onMouseDown={(e) => handleMouseDown(e, "margin-left")}
          className="h-3 hover:h-6 duration-200 w-2 bg-orange-400 border-white border-2 rounded-full cursor-ew-resize hover:bg-orange-600 -mr-2"
        />
      </div>
    </div>
  );
