    ...
    return (
      <>
        <button
          onClick={onClick}
          className={cn(
            "z-[30] rounded-full bg-gradient-to-br dark:from-blue-800 dark:via-blue-500 dark:to-blue-800 px-5 py-3 text-sm font-medium text-white shadow dark:hover:bg-blue-600/10 dark:hover:bg-b ",
            className
          )}
        >
          {children}
    ...
    return (
      <>
        <button
          ...
          disabled={load}
          className={cn(
            "duration-200  z-[30] rounded-xl bg-gradient-to-br dark:from-blue-800 dark:via-blue-500 dark:to-blue-800 px-6 py-4 text-[16px] font-medium text-white shadow dark:hover:bg-blue-600/10 dark:hover:bg-b flex items-center justify-center",
            className
          )}
        >
          {load ? (
