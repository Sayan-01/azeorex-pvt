...
const LoginForm = () => {
  ...
  return (
    <div className="z-20 w-full sm:pt-[95px] pt-[75px] md:mt-10 mt-0">
      <div className="max-w-md w-full mx-auto  rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black/60">
        <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">Welcome to Azeorex - LogIn</h2>
        <Form {...form}>
          <form
